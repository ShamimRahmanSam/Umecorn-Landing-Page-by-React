...
const HeroSection = () => {
  return (
    ...
    >
      ...
      <p className="mx-auto text-base font-normal max-w-xl md:max-w-3xl lg:max-w-4xl 2xl:max-w-6xl md:text-lg lg:text-xl 2xl:text-2xl 2xl:leading-9 mb-5 md:mb-7 2xl:mb-16 p-3 md:p-4 lg:p-6 lg:mb-10 2xl:mt-4">
